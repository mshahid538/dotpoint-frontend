...
import { change_email, resent_email_verification, social_login_change_email_verification } from '@redux/Redux/Actions';
...
const UpdateEmailChangeVerification = () => {
    //Hooks
...
export default UpdateEmailChangeVerification